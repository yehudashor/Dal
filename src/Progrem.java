...
/*public class Progrem {
    ...
    public static void main(String[] args) {
        HelpFunction.PrintCollection(DataSource.allCustomers);
        HelpFunction.PrintCollection(DataSource.allOrders);
        HelpFunction.PrintCollection(DataSource.allProducts);
        HelpFunction.PrintCollection(DataSource.allOrderProducts);
    }
}*/
...
public class Progrem
{
    public static void main(String args[]) {
        ...
        myBl.getMinOrderedProduct();
        System.out.println(myBl.getMinOrderedProduct());
